<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="Sedes.aspx.cs" Inherits="Krappsena.Models.Sedes" %>
               ...
               <div class="row">
                 <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-md-3">
                     ...
                     <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Adrian"/>
                  </div>

                  <div class="form-group col-md-3">
                     <label for="Apellido">Apellido</label>
                     <input type="text" name="apellido" id="apellido" class="form-control" placeholder="Niebles"/>
                  </div>
                  <div class="form-group col-md-3">
                     <label for="telefono">Telefono</label>
                     <input type="text" name="telefono" id="telefono" class="form-control" placeholder="309473"/>
                  </div>
